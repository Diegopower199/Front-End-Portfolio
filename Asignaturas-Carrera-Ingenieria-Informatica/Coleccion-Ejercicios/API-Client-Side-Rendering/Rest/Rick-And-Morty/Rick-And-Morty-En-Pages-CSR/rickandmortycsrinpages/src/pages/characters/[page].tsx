...
const CharactersPaginados: NextPage<{ page: number }> = (props: {
  ...
  const [characters, setCharacters] = useState<CharactersAPI | undefined>(
    undefined
  );
  ...
  return (
    <>
      ...
      <DivBusqueda>
        ...
        <input type="text" placeholder="Nombre a buscar"></input>
        <BotonClick
      ...
      <BotonPaginas>
        <BotonClick
          botonPaginaValida={characters.info.prev !== null}
          onClick={() => {
        ...
        <BotonClick
          botonPaginaValida={characters.info.next !== null}
          onClick={() => {
            location.replace(`/characters/${Number(props.page) + 1}`);
          }}
        >
